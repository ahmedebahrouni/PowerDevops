...
*/
  ...
  sh 'mvn clean package deploy:deploy-file -DgroupId=com.esprit.examen -DartifactId=deploymentRepo -Dversion=1.2 -DgeneratePom=true -Dpackaging=jar -DrepositoryId=maven-releases -Durl=http://192.168.33.10:8081/repository/maven-releases/ achat-1.0.jar'
